...
describe('createDateRangeModal', () => {
    ...
    beforeEach(() => {
        ...
        document
            .querySelectorAll('#date-range-modal')
    ...
    describe('DOM 結構', () => {
        ...
        it('預設值填入 initialStartDate 和 initialEndDate', () => {
            ...
            expect(modal.querySelector('#custom-start-date').value).toBe(
                '2026-03-15'
            )
            expect(modal.querySelector('#custom-end-date').value).toBe(
                '2026-04-15'
            )
        })
        ...
        it('快速日期按鈕包含正確的 data-range 屬性', () => {
            ...
            const ranges = Array.from(
                modal.querySelectorAll('.quick-date-btn')
