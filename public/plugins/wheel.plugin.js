export default {
    ...
    renderEdit(id = null) {
        ...
        content
            .querySelector('#wheel-save-btn')
            .addEventListener('click', () => {
                const name = content.querySelector('#wheel-name').value.trim()
                const itemsStr = content
                    .querySelector('#wheel-items')
                    .value.trim()
    ...
    spin(items) {
        ...
        const animate = timestamp => {
            ...
            if (p < 1) {
                this.angle =
                    this.startAngle +
                    (this.targetAngle - this.startAngle) * ease
                this.draw()
