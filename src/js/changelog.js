...
export const CHANGELOG = {
  "2.1.5.7": {
    date: "2026-06-08",
    title: "還款明細顯示設定與雙向跳轉高亮優化",
    features: [
      "新增還款明細顯示設定：於設定頁面『欠款管理』下，新增『顯示有連結的還款』開關，允許使用者自行決定是否將有連結記帳紀錄的還款顯示在明細列表中",
      "明細與欠款雙向跳轉定位：記帳明細列表中的欠款狀態標籤、編輯明細頁面中的關聯欠款面板，均新增前往欠款管理頁面的跳轉連結，點選後會自動篩選聯絡人、結清狀態，並平滑滾動定位至該筆卡片並高亮"
    ],
    bugfixes: [],
    improvements: [
      "防重複計算機制：確保所有還款與收回欠款明細均被排除在總收支計算與預算額度外，避免統計金額重複計算"
    ]
  },
  "2.1.5.6": {
    date: "2026-06-05",
