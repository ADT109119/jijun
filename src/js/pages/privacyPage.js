        ...
        this.app.appContainer.innerHTML = `
            <div class="page active p-4 pb-24 md:pb-8 max-w-3xl mx-auto">
                ...
                <div class="bg-wabi-surface rounded-xl shadow-sm border border-wabi-border p-6 mb-8 text-wabi-text-primary space-y-4 leading-relaxed">
                    ...
                    <h2 class="text-lg font-bold text-wabi-primary mt-6">2. 雲端同步功能</h2>
                    <p>若您選擇啟用「雲端同步」功能，本應用程式將透過 Google Identity Services 要求授權，將資料備份至您個人的 Google Drive 隱藏應用程式資料夾中。備份資料僅供您跨裝置同步與還原使用，開發者伺服器不經手亦無法存取您的 Google Drive 資料。</p>
                    ...
                    (2) 若您曾使用雲端同步功能，您可以在 Google 帳號的「安全性 > 管理第三方程式的存取權」中移除本應用程式的授權，並刪除 Google Drive 上的應用程式資料。</p>
