...
export function createDateRangeModal({
    ...
    <div class="bg-wabi-bg w-full max-w-sm rounded-2xl shadow-xl p-6 animate-modal-pop">
        ...
        <div class="grid grid-cols-3 gap-2 mb-4">
            ...
            <button class="quick-date-btn text-sm p-2 rounded-lg bg-wabi-surface border border-wabi-border" data-range="last30days">近30日</button>
  ...
  `
    ...
    modal
        .querySelector('#close-date-modal')
