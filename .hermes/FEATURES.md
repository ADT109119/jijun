...
- **2026-07-30**: test: expand categories/ledgerManager/recurringDedup tests (+57, total 984) — with OpenCode; categories 12→28 (structure validation, edge cases, null guards); ledgerManager 15→43 (updateLedger, switchLedger advancedMode, share/join/shared users, unshare); recurringDedup 9→22 (MAX_ITERATIONS guard, skipRules, error handling, multi-tx, frequency edge cases); commit e47ba36
