...
- **2026-08-01**: Code Review amortizationModal.js — 發現 1 MEDIUM (M01: 缺少分類選擇驗證，可建立空白分類的攤提計畫)、2 LOW (L01: 硬編碼 $ 貨幣符號、L02: 溢繳警告使用內建計算值比較可能有誤報)；已修復 M01 增加分類驗證 + 新增 1 個測試案例；1022 tests 全過 (原 1021 +1)；ESLint 乾淨；GitHub: 79 stars, 4 open issues (#48/#14/#9/#8) 無變化；MOZE 最新版本 v4.1.28+ (無 7-8 月更新)；Firefly III 持續翻譯修補；2026 記帳App趨勢：AI 語音記帳成熟化、本地優先趨勢
