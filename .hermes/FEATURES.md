...
- **2026-07-12**: Code Review main.js 改善 (M04/H02/L02/M01) — M04: showLedgerSwitcherPopup icon XSS 防護 (與 updateSidebarLedger 同 regex)；H02: SW controllerchange 自動 reload 前檢查使用者是否正在編輯表單；L02: SW 更新通知從 console.log 改為 showToast；M01: MAX_ITERATIONS 提取到 utils.js 常數，main.js 兩處硬編碼移除；708 tests 全過、ESLint 乾淨
